# Im create version 3
# gets the prediction and historic data from DCRUM and adds this to the POST body
...
if ($description) {
    $sn_json_object.description = $description + $hello
}
if ($measures) {
    $sn_json_object.u_measures = $measures.u_measures
}
